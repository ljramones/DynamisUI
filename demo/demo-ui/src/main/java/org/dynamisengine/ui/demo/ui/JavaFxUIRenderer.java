...
public final class JavaFxUIRenderer implements UIRenderer {
    ...
    @Override
    public void drawRect(Bounds b, org.dynamisengine.ui.api.value.Color c) {
        gc.setFill(toFx(c));
        gc.fillRect(b.x(), b.y(), b.width(), b.height());
    }

    @Override
    public void drawRectOutline(Bounds b, org.dynamisengine.ui.api.value.Color c, float stroke) {
        gc.setStroke(toFx(c));
    ...
    @Override
    public void drawRoundRect(Bounds b, org.dynamisengine.ui.api.value.Color c, float radius) {
        gc.setFill(toFx(c));
    ...
    public void drawLine(float x1, float y1, float x2, float y2,
                         org.dynamisengine.ui.api.value.Color c, float stroke) {
        gc.setStroke(toFx(c));
        gc.setLineWidth(stroke);
    ...
    public float drawText(String text, float x, float y, FontDescriptor font,
                          org.dynamisengine.ui.api.value.Color c) {
    ...
    private static Color toFx(org.dynamisengine.ui.api.value.Color c) {
